...
const handleUpdateUser = async () => {
  try {
    ...
    const response = await axios.put(`http://localhost:8080/user/updateUser?userID=${storedUserID}`, updatedUserData);
        ...
        <form className="space-y-4">
            ...
            <div className="sm:col-span-4">
              ...
              <div className="mt-2">
                ...
                />
                <span className="absolute ml-2 mt-1 items-center" onClick={handleNewPasswordToggle}>{newPasswordIcon}</span>
                </div>
