...
const AddUser = () => {
  ...
  return (
    <Root>
        ...
        <DrawerPaper>
          ...
          <List>
            ...
            <ListItem button>
              ...
              <ListItemText primary="Manage Request" onClick={handleManageRequestClick} style={{ fontFamily: "'Poppins', sans-serif" }} />
            </ListItem>
            <ListItem button style={{ marginBottom: '150px' }}>
              <ListItemIcon style={{ color: 'white' }}>
                <ArticleOutlinedIcon />
              </ListItemIcon>
              <ListItemText primary="Manage User" onClick={handleManageUserClick} />
            </ListItem>
      ...
      {/* Main Content */}
      <div className='mt-24' style={{ marginLeft: '-33.5%' }}>
        <div className='ml-12'>
          <CreateUserForm />
        </div>
      </div>
